...
function ficha(rbd){
	...
	$("#detalle-contactos").html(ficha_contactos)
	$("#gestiones_detalle-front").html(ficha_gestiones)
...
function tmp_ficha_gestiones(obj){
	...
	var html='<h4>Gestiones:<div style="float:right"><button class="btn btn-mini btn-success" onclick="agregar_gestion('+colegio.RBD+')"><i class="icon-plus icon-white"></i> Nueva gestión </button></div></h4><div><table style="font-size:10px" class="table table-crondesed">'
...
function tmp_ficha_contactos(obj){
	var colegio = obj[0].resumen
	var html='<h4>Contactos:<div style="float:right"><button class="btn btn-mini btn-success" onclick="agregar_usuario('+colegio.RBD+')"><i class="icon-plus icon-white"></i> Nuevo contacto</button></div></h4><table style="font-size:12px" class="table table-crondesed">'
